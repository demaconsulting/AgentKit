...
estimates and owns that choice. An adapter that can distinguish the conversation from the system
prompt and tool declarations passes that split, rather than leaving it to be inferred.
