...
This document contains the requirements for the AgentKit project.

## Purpose

AgentKit is a reference implementation demonstrating best practices for DEMA Consulting
