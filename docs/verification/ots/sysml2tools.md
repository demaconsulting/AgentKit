...
AgentKit model and fails the build on any syntax or reference error. The build-docs
...
`SysML2Tools_AgentKitCoreViewSvg`), before Pandoc compiles `docs/design/*.md`, which embed
...
**Requirement coverage**: `AgentKit-OTS-SysML2Tools-Lint`.
...
**Requirement coverage**: `AgentKit-OTS-SysML2Tools-Render`.

#### SysML2Tools_SoftwareStructureViewSvg

**Scenario**: The build-docs CI job runs `dotnet sysml2tools render` against the real AgentKit
...
#### SysML2Tools_AgentKitCoreViewSvg

**Scenario**: The build-docs CI job runs `dotnet sysml2tools render` against the real AgentKit
model, then FileAssert checks the resulting file at
`docs/design/generated/AgentKitCoreView.svg`.
...
- **`AgentKit-OTS-SysML2Tools-Lint`**: SysML2Tools_LintSelfTest
- **`AgentKit-OTS-SysML2Tools-Render`**: SysML2Tools_RenderSvgSelfTest,
  SysML2Tools_SoftwareStructureViewSvg, SysML2Tools_AgentKitCoreViewSvg
