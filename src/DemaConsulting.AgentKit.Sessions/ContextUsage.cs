...
public interface IContextUsageReporter
{
    ...
    ///     at. An implementation that cannot simply reports totals alone, and the whole of the usage
    ///     is treated as conversation — which rotates earlier rather than later, the safe direction
    ///     for the trigger.
    ///     </para>
    /// </remarks>
