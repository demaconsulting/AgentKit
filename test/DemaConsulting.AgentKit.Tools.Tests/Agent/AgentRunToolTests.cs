...
/// <summary>
///     Unit tests for the <see cref="AgentRunTool"/> class.
/// </summary>
/// <remarks>
///     These scenarios build the tool directly through its internal factory so that the depth, the
///     profiles and the child-composition seam can each be varied on their own. The seam is the
///     family's isolation boundary; here it is a stub that records what it was asked for.
/// </remarks>
